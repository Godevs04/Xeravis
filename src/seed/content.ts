/** Canonical marketing content for seed / fallbacks */
    ...
    process: [
      {
        ...
        description:
          'Protocol and SAP review, CDISC assessment, risk analysis, and project planning.',
      },
      {
        title: 'Clinical Data Management',
        description: 'Collection, cleaning, validation, missing data review, and transformation.',
      },
      {
...
export const SEED_TECHNOLOGIES = [
  ...
  },
  {
    ...
    slug: 'hugging-face',
    category: 'ai',
    description: 'Model hub and NLP tooling.',
  },
  {
    title: 'LangChain',
    slug: 'langchain',
  ...
  },
  {
    ...
    slug: 'databricks',
    category: 'data',
    description: 'Lakehouse analytics and ML.',
  },
  {
    title: 'AWS',
    slug: 'aws',
  ...
  },
  {
    ...
    slug: 'docker',
    category: 'devops',
    description: 'Containerized application delivery.',
  },
  {
    title: 'Kubernetes',
    slug: 'kubernetes',
